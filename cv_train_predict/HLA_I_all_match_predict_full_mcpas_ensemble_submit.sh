...
do
  ...
  DePTH predict --test_file data/HLA_I_full_mcpas/test/test_pos.csv \
                --hla_class HLA_I \
                --output_dir results/predicted_scores/HLA_I_all_match_full_mcpas_ensemble/HLA_I_all_match_full_mcpas_pos_test_${rseed}_${np_seed}_${tf_seed} \
                --default_model False \
    ...
    DePTH predict --test_file data/HLA_I_full_mcpas/test/test_neg.csv \
                  --hla_class HLA_I \
                  --output_dir results/predicted_scores/HLA_I_all_match_full_mcpas_ensemble/HLA_I_all_match_full_mcpas_neg_test_${rseed}_${np_seed}_${tf_seed} \
                  --default_model False \
                  --model_dir saved_models/HLA_I_all_match_ensemble/HLA_I_all_match_model_${rseed}_${np_seed}_${tf_seed} \
                  --enc_method one_hot
